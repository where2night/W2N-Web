...
<tr>
	...
	<ul class="nav nav-tabs" style="border: 1.5px solid #FF6B24; background-color: #000000;">
  		<li class="active"><a href="#Eventos" data-toggle="tab" >Proximos Eventos</a></li>
  		<li><a href="#Listas" data-toggle="tab">Listas de locales</a></li>
  		<li><a href="#MisEventos" data-toggle="tab">Mis eventos</a></li>
	</ul>
