											...
											<div class="tab-pane fade in active" id="tab-basic">
												 <form class="form-horizontal" style="width:99%"role="form">
                                                        <div class="form-group">
                                                            <label for="name" class="col-lg-2 control-label" style="color:#ff6b24;font-size:13px;">Nombre Local</label>
                                                            <div class="col-lg-9">
                                                                <input type="email" class="form-control" style=""id="name" placeholder="Nombre Local" value="<?php echo $_SESSION['local_name']; ?>">
                                                            </div>
                                                        </div>
											...
											<div class="tab-pane fade " id="tab-details">
												 <form class="form-horizontal " style="width:99%"role="form">
														...
														<div class="form-group">
                                                            ...
                                                            <div class="col-lg-2" >
                                                                 <input id="timepicker_open" style="height:30px"value="<?php echo $_SESSION[opening_hours];?>" />
                                                            </div>
															<label for="timepicker_close" class="col-lg-2 control-label"style="color:#ff6b24;font-size:13px;">Cierre</label>
                                                            <div class="col-lg-2">
                                                                <input id="timepicker_close" style="height:30px"value="<?php echo $_SESSION[close_hours];?>" />
                                                            </div>
                                                        </div>
